...
import com.project.cinema.security.auth.RestAuthenticationEntryPoint;
import com.project.cinema.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/auth/sign-out", "/api/movie");
